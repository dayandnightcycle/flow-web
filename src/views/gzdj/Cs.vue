...
<script setup>
    ...
    var data = {
        ...
        djdjb: "select DJYY,GYFS,SLBH,SQZSBS,SQFBCZ, SQRQ, SQNR, SQBZ, DJRQ, DBR, ZSR, FZJG, FZRQ, DAMJ, QT, FJ, XGZH, BDCDYH, LIFECYCLE,DJRQ,GDH,SPBZ from DJ_DJB where slbh='" +
            slbh +
            "'",
        djpzyj: "select SPBH,SLBH,SPDX,SPXH,SPR,SPRQ,SPRZGZH,SPJG,SPZT,SPYJ,SPTXR from DJ_SPB where SLBH = '" +
            slbh +
            "' AND SPDX = '批准意见'",
        djshyj: "select SPBH,SLBH,SPDX,SPXH,SPR,SPRQ,SPRZGZH,SPJG,SPZT,SPYJ,SPTXR from DJ_SPB where SLBH = '" +
            slbh +
            "' AND SPDX = '审核意见'",
        djcsyj: "select SPBH,SLBH,SPDX,SPXH,SPR,SPRQ,SPRZGZH,SPJG,SPZT,SPYJ,SPTXR from DJ_SPB where SLBH = '" +
            slbh +
            "' AND SPDX = '初审意见'",
    ...
    const getformJson = () => {
        proxy.$http
            ...
            .then((res) => {
                ...
                proxy.newFormData2.XGZH = proxy.newFormData.djdjb[0].XGZH;
                ...
                proxy.newFormData2.SJSJ = proxy.newFormData.djdjb[0].SJSJ;
                proxy.newFormData2.CNSJ = proxy.newFormData.djdjb[0].CNSJ;
                proxy.newFormData2.GYFS = proxy.newFormData.djdjb[0].GYFS;
                proxy.newFormData2.XGZHZL = proxy.newFormData.djsjd[0].ZL;
                ...
                proxy.newFormData2.ZL = proxy.newFormData.djsjd[0].ZL;
                proxy.newFormData2.LCLB = proxy.newFormData.djsjd[0].LCLB;
                // 房屋登记信息
                proxy.newFormData2.QLQTZK = proxy.newFormData.djdjb[0].QT;
                proxy.newFormData2.FJ = proxy.newFormData.djdjb[0].FJ;
                ...
                proxy.newFormData2.FTTDMJ = (proxy.newFormData.qlfwxg[0].TNJZMJ) || "";
    ...
    const conserve = () => {
        ...
        //qlfwxg
        var data3 = {
            djspb: "insert into dj_spb(spbh,slbh,spdx,spyj,spr,sprq,spzt,sptxr,sprzgzh)values('" +
                spbh1 +
                "','" +
                slbh +
                "','" +
