...
<script setup>
    ...
    var data = {
        ...
        djfjd: "select SLBH, QLR, LJR, LJRSFZJLX, LJRSFZJH, LJRYQLRDGX, FJR, FJRQ, FJBZ, LJRZW, LJRZP from DJ_FJD where SLBH = " +
            "'" +
            slbh +
            "'",
        djljr: "select LJBH, SLBH, LJR, LJRSFZJLX, LJRSFZJH, LJRYQLRDGX, LJRZW, LJRZP from DJ_FJD_LJR where SLBH = " +
            "'" +
            slbh +
            "'",
    ...
    const conserve = () => {
        ...
        //qlfwxg
        var data3 = {
            djfjd: "insert into dj_fjd (slbh,ljr,ljrsfzjlx,ljrsfzjh,ljryqlrdgx,fjr,fjrq,fjbz)values('" +
                slbh +
                "','" +
                ljr +
                "','" +
