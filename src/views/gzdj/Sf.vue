      ...
      <el-dialog v-model="dialogFormVisible" title="选择收费">
        <el-form :model="form" label-width="120px">
          <el-form-item label="下一个表单">
            <el-input v-model="input" placeholder="gzdj-cs.json" />
            <!--<el-select
...
<script setup>
    ...
    var data = {
        ...
        djdjb: "Select SLBH,SQFBCZ,GYFS,DJLX,DJYY,DJRQ,SQRQ,XGZH from DJ_DJB where SLBH = " +
            "'" +
            slbh +
            "'",
        djsfd: "select SLBH, JFBH, XMMC, JFDW, TXDZ, DH, JFLX, JBR, JBRQ, JBYJ, SHR, SHYJ, SHRQ, YSJE, SSJE, SKR, SKRQ, SKYJ, SLR,SFBZ,YYS,GRSDS,QS,TDZZS from DJ_SFD where SLBH =" +
            "'" +
            slbh +
            "'",
    ...
    const conserve = () => {
        ...
        //qlfwxg
        var data3 = {
            djsfd: "insert into dj_sfd(slbh,jfbh,xmmc,jfdw,txdz,dh,jflx,jbr,jbrq,shr,shrq,ysje,ssje,skr,skrq,slr,sfbz,yys,grsds,qs,tdzzs)values('" +
                slbh +
                "','" +
                jfbh +
                "','" +
